      ...
      {activeTab === 'location' && (
        <View style={{ gap: 14 }}>
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 14, fontWeight: '800', fontFamily: 'Nunito-Bold', color: colors.sage, marginTop: 8 }}>
            ...
            <View style={{ gap: 8 }}>
              {[
                ...
                <View key={item.label} style={{ flexDirection: 'row', gap: 8 }}>
                  <Text style={{ fontSize: 14, fontWeight: '900', fontFamily: 'Nunito-Black', color: colors.ink, width: 100 }}>{item.label}:</Text>
                  <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'Nunito-SemiBold', color: colors.graphite, flex: 1 }}>{item.value}</Text>
                </View>
              ))}
            </View>
          </View>
        ...
        <View style={{ gap: 14 }}>
          <View style={{ borderRadius: 22, padding: 20, backgroundColor: '#1e1b4b', gap: 14 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <Text style={{ fontSize: 16, fontWeight: '700', fontFamily: 'Nunito-Bold', color: 'rgba(255,255,255,0.7)' }}>
            ...
            <Text style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', fontWeight: '600', fontFamily: 'Nunito-SemiBold' }}>
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            {[
              ...
              >
                ...
                <Text style={{ fontSize: 13, fontWeight: '700', fontFamily: 'Nunito-Bold', color: colors.pewter, marginTop: 4 }}>{btn.label}</Text>
              </TouchableOpacity>
            ))}
          </View>
        </View>
